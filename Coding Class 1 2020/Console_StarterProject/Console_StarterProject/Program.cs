...
//Standard if chain
            ...
            if (userChoiceOperator == 1)
                    ...
                    //Establishes an answer then asks the user with the answer in mind
                        int ab = Int32.Parse(Console.ReadLine());
                    //Parses and reads the user's input in the same line
                        if (an == ab)
                        {
                            Console.WriteLine("{0} is correct!", ab);
                        }
                        if (an != ab)
                        {
                            Console.WriteLine("Good try, but no: {0} % {1} = {2}", A, B, an);
                        }
                    }
            ...
            if (userChoiceOperator == 2)
                    ...
                    //Parses and reads the user's input in the same line
                        ...
                        if (an != ab)
                            Console.WriteLine("Good try, but no: {0} * {1} = {2}", A, B, an);
                    //Calls resources in same WriteLines
                    }
            ...
            if (userChoiceOperator == 4)
                    ...
                    //Division Mod Combo
                        ...
                        if (an == ab)
                            Console.WriteLine("{0} is correct!", ab);
                        if (an != ab)
                            Console.WriteLine("Good try, but no: ({0} / {1}) % {2} = {3}", A, B, C, an);
                    }
...
//Standard if else if else if chain
...
//Case switch chain utilizing userChoiceOperator as the switch variable
