...
namespace A3_Date
{
    class Birthday
    {
        static void Main(string[] args)
        {
            ...
            //Validate if the month submitted is contextually sensible
            Console.WriteLine("What is today's month?: ");
            while (todayMonth < 1 || todayMonth > 12)
            {
                if (Int32.TryParse(Console.ReadLine(), out todayMonth) == false)
                {
                    Console.WriteLine("Sorry User, you need to type a valid month; between 1 and 12: ");
                }
                else if (todayMonth < 1)
                {
                    Console.WriteLine("You need to type in a month date that is 1 or greater, User: ");
                }
                else if (todayMonth > 12)
                {
                    Console.WriteLine("You need to type in a month date that is 12 or less, User: ");
                }
            }
            //Temporary storage for month
            today = new MyDate(todayMonth, -1);

            //Validate if day is valid between 1 and the daysInMonth()
            Console.WriteLine("What is today's day?: ");
            while (todayDay < 1 || todayDay > today.daysInMonth())
            {
                if (Int32.TryParse(Console.ReadLine(), out todayDay) == false)
                {
                    Console.WriteLine("Sorry User, you need to type a valid day; between 1 and {0}: ", today.daysInMonth());
                }
                else if (todayDay < 1)
                {
                    Console.WriteLine("You need to type in a day that is 1 or greater, User: ");
                }
                else if (todayDay > today.daysInMonth())
                {
                    Console.WriteLine("You need to type in a day that is {0} or less, User: ", today.daysInMonth());
                }
            }
            //Full Stored.
            today = new MyDate(todayMonth, todayDay);

            //Validate if the birthday month submitted is contextually sensible
            Console.WriteLine("What is your birthday month?: ");
            while (bdayMonth < 1 || bdayMonth > 12)
            {
                if (Int32.TryParse(Console.ReadLine(), out bdayMonth) == false)
                {
                    Console.WriteLine("Sorry User, you need to type a valid month; between 1 and 12: ");
                }
                else if (bdayMonth < 1)
            ...
            //Temporary storage for the month
            bday = new MyDate(bdayMonth, -1);

            //Validate if day is valid between 1 and the birthday.daysInMont()
            Console.WriteLine("What is your birthday day?: ");
            while (bdayDay < 1 || bdayDay > bday.daysInMonth())
            {
                if (Int32.TryParse(Console.ReadLine(), out bdayDay) == false)
                {
                    Console.WriteLine("Sorry User, you need to type a valid day; between 1 and {0}: ", bday.daysInMonth());
                }
                else if (bdayDay < 1)
                {
                    Console.WriteLine("You need to type in a day that is 1 or greater, User: ");
                }
                else if (bdayDay > bday.daysInMonth())
                {
                    Console.WriteLine("You need to type in a day that is {0} or less, User: ", bday.daysInMonth());
                }
            }
            //Fully store bday
            bday = new MyDate(bdayMonth, bdayDay);
            ...
            while (today.equals(bday.getMonth(), bday.getDay()) != true)
            {
                today.nextDay();
            // To test if the dates printed correctly and incrementally. 
            //    Console.WriteLine("{0} month {1} day", today.getMonth(), today.getDay());
                daystilbday++;
            }
            switch(daystilbday)
            {
                case 0:
                    ...
                    break;
                default:
                    Console.WriteLine("Number of days until birthday {0}: {1}", bday.toString(), daystilbday);
                    break;
            }
