    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int iQuiz = 0; iQuiz < numTimesToQuiz; iQuiz++)
            {
                ...
                //if (userChoiceOperator == 1) //Modulus
                //{
                //    int userinput;
                //    Console.WriteLine("What is the result of {0} % {1} ?", A, B);
                //    string input = Console.ReadLine(); // String to be parsed
                //    if (!Int32.TryParse(input, out userinput)) // Check for parsable number
                //    {
                //        Console.WriteLine("You have to write in a whole number!");
                //        continue;
                //    }
                //    if (userinput == A % B)
                //    {
                //        Console.WriteLine("{0} is correct!", (A % B));
                //        continue;
                //    }
                //    if (userinput != A % B)
                //    {
                //        Console.WriteLine("Good try, but no: {0} % {1} = {2}", A, B, A % B);
                //        continue;
                //    }
                //    continue;
                //}

                //if (userChoiceOperator == 2) //Multiplication
                //{
                //    int userinput;
                //    Console.WriteLine("What is the result of {0} * {1} ?", A, B);
                ...
                //if (userChoiceOperator == 3) //Division
                //{
                //    int userinput;
                //    Console.WriteLine("What is the result of {0} / {1} ?", A, B);
                //    string input = Console.ReadLine();
                ...
                //if (userChoiceOperator == 4) //Division Modulus
                //{
                //    int userinput;
                ...
                //    if (userinput == (A / B % C))
                //    {
                //        Console.WriteLine("{0} is correct!", A / B % C);
                //        continue;
                //    }
                //    if (userinput != ((A / B) % C))
                //    {
                //        Console.WriteLine("Good try, but no: ({0} / {1}) % {2} = {3}", A, B, C, A / B % C);
                //        continue;
                //    }
                //    continue;
                //}
                ...
                //    if (!Int32.TryParse(input, out userinput)) // Check for parsable number
                //        Console.WriteLine("You have to write in a whole number!");
                //    else if (userinput == A % B)
                //        Console.WriteLine("{0} is correct!", (A % B));
                //    else
                //        Console.WriteLine("Good try, but no: {0} % {1} = {2}", A, B, A % B);
                //}
                //else if (userChoiceOperator == 2) //Multiplication
                //{
                //    Console.WriteLine("What is the result of {0} * {1} ?", A, B);
                //    int userinput;
                //    string input = Console.ReadLine();
                ...
                //        Console.WriteLine("Good try, but no: {0} * {1} = {2}", A, B, A * B);
                //}
                //else if (userChoiceOperator == 3) //Division
                //{
                //    Console.WriteLine("What is the result of {0} / {1} ?", A, B);
                //    int userinput;
                //    string input = Console.ReadLine();
                    ...
                    case 2://Multiplication
                        {
                            ...
                            if (!Int32.TryParse(input, out userinput)) // Check for parsable number
                                Console.WriteLine("You have to write in a whole number!");
                            else if (userinput == A * B) //Multiply
                                Console.WriteLine("{0} is correct!", (A * B));
                            else
                                Console.WriteLine("Good try, but no: {0} * {1} = {2}", A, B, A * B);
                        }
